...
git clone --depth 1 https://github.com/destan19/OpenAppFilter package/deng/luci-app-oaf
...
git clone https://github.com/Openwrt-Passwall/openwrt-passwall-packages package/deng/passwall-packages
